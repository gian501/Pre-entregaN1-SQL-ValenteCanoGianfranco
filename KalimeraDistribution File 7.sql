...
CREATE TABLE IF NOT EXISTS `Kalimera Distribution`.`KALIMERA DISTRIBUTION` (
  ...
  INDEX `fk_KALIMERA DISTRIBUTION_CLIENTES1_idx` (`Id_clientes` ASC) VISIBLE,
  INDEX `fk_KALIMERA DISTRIBUTION_PERSONAL1_idx` (`Id_personal` ASC) VISIBLE,
  INDEX `fk_KALIMERA DISTRIBUTION_PRODUCTOS1_idx` (`Id_producto` ASC) VISIBLE,
  INDEX `fk_KALIMERA DISTRIBUTION_PROVEEDORES1_idx` (`Id_proveedor` ASC) VISIBLE,
  CONSTRAINT `fk_KALIMERA DISTRIBUTION_CLIENTES1`
    FOREIGN KEY (`Id_clientes`)
    REFERENCES `Kalimera Distribution`.`CLIENTES` (`Id_clientes`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_KALIMERA DISTRIBUTION_PERSONAL1`
    FOREIGN KEY (`Id_personal`)
    REFERENCES `Kalimera Distribution`.`PERSONAL` (`Id_personal`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_KALIMERA DISTRIBUTION_PRODUCTOS1`
    FOREIGN KEY (`Id_producto`)
    REFERENCES `Kalimera Distribution`.`PRODUCTOS` (`Id_producto`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_KALIMERA DISTRIBUTION_PROVEEDORES1`
    FOREIGN KEY (`Id_proveedor`)
    REFERENCES `Kalimera Distribution`.`PROVEEDORES` (`Id_proveedor`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
